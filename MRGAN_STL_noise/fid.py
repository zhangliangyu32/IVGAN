...
def compute_dataset_statistics(target_set="STL10", batch_size=50, dims=2048, cuda=True, device='cuda:0'):
    imageSize = 64
    if target_set == "CIFAR10":
        ...
        dataset = datasets.LSUN(root='~/datasets/data_lsun', classes='church_outdoor',
                        transform=transforms.Compose([
                            transforms.Resize(imageSize),
        ...
        dataset = datasets.STL10(root='~/datasets/data_stl10', split='unlabeled',
                            transform=transforms.Compose([
                                transforms.Resize(imageSize),
                                transforms.CenterCrop(imageSize),
                                transforms.ToTensor(),
